...
// activate content subscribe

const subscribeForm = document.getElementById('subscribe-form');

    subscribeForm.addEventListener('submit', function(event) {
        // Mencegah halaman reload (refresh) saat submit
...
const modalViews = document.getElementById('booking-modal'),
      modalBtns = document.querySelectorAll('.about__data .button'), // Mengambil tombol di About
